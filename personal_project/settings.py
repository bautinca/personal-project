...
TEMPLATES = [
    {
        ...
        "DIRS": [
            BASE_DIR
            / "templates"  # Los templates del proyecto se encuentran en la carpeta 'templates' dentro del directorio base del proyecto
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
# Hacemos que el proyecto de Django use por defecto la base de datos PostgreSQL
DATABASES = {
    "default": {
